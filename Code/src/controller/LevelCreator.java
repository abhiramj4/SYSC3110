...
public class LevelCreator {
	...
	public Scene getLevelCreatorScene() {
		...
		Text title = new Text("Level Builder");
		title.setStyle("-fx-font-size: 20px;");

		Scene scene = new Scene(root, WIDTH, HEIGHT);
		root.getChildren().addAll(title, plantPane, zombiePane, numZomb, numRound, buttonPane);

		VBox.setMargin(title, new Insets(20, 20, 20, 20));
		VBox.setMargin(plantPane, new Insets(0, 0, 20, 20));
		VBox.setMargin(zombiePane, new Insets(0, 0, 20, 20));
		VBox.setMargin(numZomb, new Insets(0, 0, 20, 20));
		VBox.setMargin(numRound, new Insets(0, 0, 20, 20));
		VBox.setMargin(buttonPane, new Insets(0, 0, 20, 20));

		ObservableList<String> options = FXCollections.observableArrayList("Sunflower", "Peashooter", "CherryBomb",
				"Wallnut");
		...
		ObservableList<String> options2 = FXCollections.observableArrayList("BaseZombie", "ConeHeadZombie",
				"FlagZombie");
